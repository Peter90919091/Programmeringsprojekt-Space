...
int levelControls(int difficulty) {
	...
	if (difficulty == 6) {speed = 8;level = 6;pause = 0;Asteroid1(0,14,6); Asteroid1(1, 14, 12);Asteroid2(0,14,18);Asteroid2(1,14,24);Asteroid3(0,130,6);Asteroid3(1,130,12); Asteroid4(0,120,18); Asteroid4(1,130,28);}
